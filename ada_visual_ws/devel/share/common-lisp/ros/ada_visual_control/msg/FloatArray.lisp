...
(cl:defmethod cl:initialize-instance :after ((m <FloatArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FloatArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ada_visual_control-msg:<FloatArray> is deprecated: use ada_visual_control-msg:FloatArray instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <FloatArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ada_visual_control-msg:data-val is deprecated.  Use ada_visual_control-msg:data instead.")
  (data m))
